...
class Usuario(AbstractBaseUser):
    ...
    #unidade = models.ForeignKeyField('unidade.Unidade', verbose_name= 'Unidade de Pronto Atendimento *')#, on_delete=models.PROTECT, related_name='unidade')
    ...
    enfermeiro = EnfermeiroAtivoManager()
